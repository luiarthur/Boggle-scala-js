...
$c_LBoggle_Main$.prototype.getDict__sci_Vector = (function() {
  ...
  return $as_sci_Vector(b.result__O())
});
$c_LBoggle_Main$.prototype.init___ = (function() {
  $n_LBoggle_Main$ = this;
  this.dice$1 = this.getDice__sci_Vector();
  this.dict$1 = this.getDict__sci_Vector();
  this.board$1 = new $c_LBoggle_Board().init___sci_Vector__sci_Vector__I(this.dice$1, this.dict$1, 3);
  return this
});
$c_LBoggle_Main$.prototype.getDice__sci_Vector = (function() {
  ...
  b.$$plus$plus$eq__sc_TraversableOnce__scg_Growable(new $c_scm_WrappedArray$ofRef().init___AO(xs));
  var lines = $as_sci_Vector(b.result__O());
  $m_sci_Vector$();
  ...
  var this$8 = lines.iterator__sci_VectorIterator();
  while (this$8.$$undhasNext$2) {
    var arg1 = this$8.next__O();
    var line = $as_T(arg1);
    var thiz$2 = $as_T(line.trim());
    var xs$1 = $m_sjsr_RuntimeString$().split__T__T__I__AT(thiz$2, ",", 0);
    $m_sci_Vector$();
    ...
    b$1.$$plus$eq__O__scm_Builder(new $c_LBoggle_Die().init___sci_Vector($as_sci_Vector(b$2.result__O())))
  };
...
$c_LBoggle_Main$.prototype.showBoard__V = (function() {
  ...
  while (this$7.$$undhasNext$2) {
    ...
    var row = $as_sci_Vector(arg1);
    $m_sci_Vector$();
    var bf = $m_sc_IndexedSeq$().ReusableCBF$6;
    var b = $f_sc_TraversableLike__builder$1__psc_TraversableLike__scg_CanBuildFrom__scm_Builder(row, bf);
    var this$9 = row.iterator__sci_VectorIterator();
    while (this$9.$$undhasNext$2) {
      var arg1$1 = this$9.next__O();
      var c = $as_T(arg1$1);
      var this$12 = new $c_sci_StringOps().init___T("%2s");
      var array = [c];
      var args = new $c_sjs_js_WrappedArray().init___sjs_js_Array(array);
      b.$$plus$eq__O__scm_Builder($f_sci_StringLike__format__sc_Seq__T(this$12, args))
    };
...
$c_LBoggle_Main$.prototype.$$js$exported$meth$main__O = (function() {
  this.main__V()
});
$c_LBoggle_Main$.prototype.readContent__T__T = (function(url) {
  var content = new $c_sr_ObjectRef().init___O("");
  var ajaxSettings = {
    "url": url,
    "type": "GET",
    "success": (function($this, content$1) {
      return (function(data$2) {
        var data = $as_T(data$2);
        content$1.elem$1 = (("" + $as_T(content$1.elem$1)) + data)
      })
    })(this, content),
    "async": false
  };
...
var $d_LBoggle_Main$ = new $TypeData().initClass({
  LBoggle_Main$: 0
}, false, "Boggle.Main$", {
  LBoggle_Main$: 1,
  O: 1,
...
$c_LBoggle_Main$.prototype.$classData = $d_LBoggle_Main$;
var $n_LBoggle_Main$ = (void 0);
function $m_LBoggle_Main$() {
  if ((!$n_LBoggle_Main$)) {
    $n_LBoggle_Main$ = new $c_LBoggle_Main$().init___()
  };
  return $n_LBoggle_Main$
}
/** @constructor */
...
$c_LBoggle_Board.prototype.chain__sci_Vector__T = (function(path) {
  $m_sci_Vector$();
  var bf = $m_sc_IndexedSeq$().ReusableCBF$6;
  var b = $f_sc_TraversableLike__builder$1__psc_TraversableLike__scg_CanBuildFrom__scm_Builder(path, bf);
  var this$2 = path.iterator__sci_VectorIterator();
  while (this$2.$$undhasNext$2) {
    var arg1 = this$2.next__O();
    var coord = $as_LBoggle_Coord(arg1);
    b.$$plus$eq__O__scm_Builder($as_T(this.letters$1.apply__I__I__O(coord.x$1, coord.y$1)))
  };
...
$c_LBoggle_Board.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    ...
    var x = this.dice$1;
    var x$2 = Board$1.dice$1;
    if (((x === null) ? (x$2 === null) : $f_sc_GenSeqLike__equals__O__Z(x, x$2))) {
      var x$3 = this.dictionary$1;
      var x$4 = Board$1.dictionary$1;
      var jsx$1 = ((x$3 === null) ? (x$4 === null) : $f_sc_GenSeqLike__equals__O__Z(x$3, x$4))
    } else {
      var jsx$1 = false
    };
    if (jsx$1) {
      return (this.minLetters$1 === Board$1.minLetters$1)
    } else {
      return false
    }
  } else {
...
$c_LBoggle_Board.prototype.init___sci_Vector__sci_Vector__I = (function(dice, dictionary, minLetters) {
  this.dice$1 = dice;
  this.dictionary$1 = dictionary;
  this.minLetters$1 = minLetters;
  this.numDice$1 = dice.length__I();
  ...
  $m_sci_Vector$();
  var bf = $m_sc_IndexedSeq$().ReusableCBF$6;
  var b = $f_sc_TraversableLike__builder$1__psc_TraversableLike__scg_CanBuildFrom__scm_Builder(dice, bf);
  var this$4 = dice.iterator__sci_VectorIterator();
  while (this$4.$$undhasNext$2) {
    var arg1 = this$4.next__O();
    var x$1 = $as_LBoggle_Die(arg1);
    b.$$plus$eq__O__scm_Builder(x$1.roll__T())
  };
  this.letters$1 = new $c_LBoggle_Matrix().init___sci_Vector__I__I__s_reflect_ClassTag($as_sci_Vector(b.result__O()), this.nrow$1, this.ncol$1, new $c_s_reflect_ClassTag$GenericClassTag().init___jl_Class($d_T.getClassOf())).shuffled__LBoggle_Matrix();
  var f = (function(this$2$1) {
    return (function(w$2) {
      var w = $as_T(w$2);
      return ($uI(w.length) >= this$2$1.minLetters$1)
    })
  })(this);
  if ((dictionary instanceof $c_sci_List)) {
    var x2 = $as_sci_List(dictionary);
    var l = x2;
    var l$1 = l;
    x: {
      var result;
        ...
        if (l$1.isEmpty__Z()) {
          ...
          _allIn: while (true) {
            if (remaining$1.isEmpty__Z()) {
              ...
              if (($uZ(f(x$2)) !== false)) {
                var this$8 = remaining$1;
                remaining$1 = this$8.tail__sci_List();
                continue _allIn
              };
              ...
              while ((toProcess !== firstMiss)) {
                ...
                currentLast = newElem;
                var this$9 = toProcess;
                toProcess = this$9.tail__sci_List()
              };
              ...
              while ((!next.isEmpty__Z())) {
                ...
                if (($uZ(f(head)) !== false)) {
                  var this$10 = next;
                  next = this$10.tail__sci_List()
                } else {
                  while ((nextToCopy !== next)) {
                    var newElem$2 = new $c_sci_$colon$colon().init___O__sci_List(nextToCopy.head__O(), $m_sci_Nil$());
                    currentLast.tl$5 = newElem$2;
                    currentLast = newElem$2;
                    var this$11 = nextToCopy;
                    nextToCopy = this$11.tail__sci_List()
                  };
                  var this$12 = next;
                  nextToCopy = this$12.tail__sci_List();
                  var this$13 = next;
                  next = this$13.tail__sci_List()
                }
              };
    ...
    var this$15 = dictionary.iterator__sci_VectorIterator();
    while (this$15.$$undhasNext$2) {
      var arg1$1 = this$15.next__O();
      if (($uZ(f(arg1$1)) !== false)) {
        b$1.$$plus$eq__O__sci_VectorBuilder(arg1$1)
      }
    };
    var jsx$1 = b$1.result__sci_Vector()
  };
  this.shortDict$1 = $as_sci_Vector(jsx$1);
  $m_sci_List$();
  var array = [new $c_LBoggle_Coord().init___I__I(0, 1), new $c_LBoggle_Coord().init___I__I(1, 0), new $c_LBoggle_Coord().init___I__I(1, 1), new $c_LBoggle_Coord().init___I__I((-1), (-1)), new $c_LBoggle_Coord().init___I__I(0, (-1)), new $c_LBoggle_Coord().init___I__I((-1), 0), new $c_LBoggle_Coord().init___I__I((-1), 1), new $c_LBoggle_Coord().init___I__I(1, (-1))];
  var i = (((-1) + $uI(array.length)) | 0);
  var result$1 = $m_sci_Nil$();
  while ((i >= 0)) {
    var this$19 = result$1;
    var index = i;
    var x$3 = array[index];
    result$1 = new $c_sci_$colon$colon().init___O__sci_List(x$3, this$19);
    i = (((-1) + i) | 0)
  };
  this.allMoves$1 = result$1;
  return this
});
$c_LBoggle_Board.prototype.toString__T = (function() {
  return this.letters$1.toString__T()
});
$c_LBoggle_Board.prototype.solve__sci_Vector = (function() {
  $m_s_package$();
  var n1 = this.nrow$1;
  var n2 = this.ncol$1;
  ...
  while ((i < n1)) {
    ...
    while ((i$1 < n2)) {
      var arg1$1 = i$1;
      var jsx$2 = this.shortDict$1;
      var this$4 = $m_s_package$().Vector$1;
      var array = [new $c_LBoggle_Coord().init___I__I(arg1, arg1$1)];
      if (($uI(array.length) === 0)) {
        ...
        var jsx$1 = b$2.result__sci_Vector()
      };
      var elem = this.$$undsolve__p1__sci_Vector__sci_Vector__sci_Vector__sci_Vector(jsx$2, jsx$1, $as_sci_Vector($m_s_package$().Vector$1.apply__sc_Seq__sc_GenTraversable($m_sci_Nil$())));
  ...
  var this$6 = b.result__sci_Vector();
  $m_sci_Vector$();
  var bf = $m_sc_IndexedSeq$().ReusableCBF$6;
  var b$3 = $f_sc_TraversableLike__builder$1__psc_TraversableLike__scg_CanBuildFrom__scm_Builder(this$6, bf);
  var this$7 = this$6.iterator__sci_VectorIterator();
  while (this$7.$$undhasNext$2) {
    var arg1$3 = this$7.next__O();
    var x$4 = $as_sci_Vector(arg1$3);
    $m_sci_Vector$();
    var b$4 = new $c_sci_VectorBuilder().init___();
    var this$9 = x$4.iterator__sci_VectorIterator();
    while (this$9.$$undhasNext$2) {
      var arg1$4 = this$9.next__O();
      var xs = $as_sc_GenTraversableOnce(arg1$4).seq__sc_TraversableOnce();
      $as_sci_VectorBuilder($f_scg_Growable__$$plus$plus$eq__sc_TraversableOnce__scg_Growable(b$4, xs))
    };
    b$3.$$plus$eq__O__scm_Builder(b$4.result__sci_Vector())
  };
  var allSolutions = $as_sci_Vector(b$3.result__O());
  $m_sci_Vector$();
  var b$5 = new $c_sci_VectorBuilder().init___();
  var this$11 = allSolutions.iterator__sci_VectorIterator();
  while (this$11.$$undhasNext$2) {
    var arg1$5 = this$11.next__O();
    var xs$1 = $as_sc_GenTraversableOnce(arg1$5).seq__sc_TraversableOnce();
    $as_sci_VectorBuilder($f_scg_Growable__$$plus$plus$eq__sc_TraversableOnce__scg_Growable(b$5, xs$1))
  };
  var this$12 = b$5.result__sci_Vector();
  var this$13 = $as_sc_SeqLike($f_sc_SeqLike__distinct__O(this$12));
  var ord = $m_s_math_Ordering$String$();
  var this$15 = $as_sc_SeqLike($f_sc_SeqLike__sorted__s_math_Ordering__O(this$13, ord));
  ...
  return $as_sci_Vector($f_sc_SeqLike__sortBy__F1__s_math_Ordering__O(this$15, f, ord$1))
});
...
$c_LBoggle_Board.prototype.isValidMove__sci_Vector__LBoggle_Coord__Z = (function(path, move) {
  var pos = this.makeMove__sci_Vector__LBoggle_Coord__LBoggle_Coord(path, move);
  return ((!this.visited__sci_Vector__LBoggle_Coord__Z(path, pos)) && this.onBoard__LBoggle_Coord__Z(pos))
});
$c_LBoggle_Board.prototype.shuffle__V = (function() {
  var this$2 = this.dice$1;
  $m_sci_Vector$();
  var bf = $m_sc_IndexedSeq$().ReusableCBF$6;
  ...
  while (this$3.$$undhasNext$2) {
    ...
    b.$$plus$eq__O__scm_Builder(x$2.roll__T())
  };
  this.letters$1 = new $c_LBoggle_Matrix().init___sci_Vector__I__I__s_reflect_ClassTag($as_sci_Vector(b.result__O()), this.nrow$1, this.ncol$1, new $c_s_reflect_ClassTag$GenericClassTag().init___jl_Class($d_T.getClassOf())).shuffled__LBoggle_Matrix()
});
...
$c_LBoggle_Board.prototype.$$undsolve__p1__sci_Vector__sci_Vector__sci_Vector__sci_Vector = (function(dict, path, solution) {
  if ((dict.length__I() === 0)) {
    return solution
  } else {
    var this$1 = this.allMoves$1;
    var f = (function($this, path$1) {
      return (function(move$2) {
        var move = $as_LBoggle_Coord(move$2);
        return $this.isValidMove__sci_Vector__LBoggle_Coord__Z(path$1, move)
      })
    })(this, path);
    if ((this$1 !== null)) {
      var l = this$1;
          ...
          if (l$1.isEmpty__Z()) {
            ...
            _allIn: while (true) {
              if (remaining$1.isEmpty__Z()) {
                ...
                var x$2 = remaining$1.head__O();
                if (($uZ(f(x$2)) !== false)) {
                  var this$3 = remaining$1;
                  remaining$1 = this$3.tail__sci_List();
                  continue _allIn
                };
                var firstMiss = remaining$1;
                var newHead = new $c_sci_$colon$colon().init___O__sci_List(start.head__O(), $m_sci_Nil$());
                ...
                while ((toProcess !== firstMiss)) {
                  ...
                  currentLast.tl$5 = newElem;
                  currentLast = newElem;
                  var this$4 = toProcess;
                  toProcess = this$4.tail__sci_List()
                };
                var next = firstMiss.tail__sci_List();
                var nextToCopy = next;
                while ((!next.isEmpty__Z())) {
                  ...
                  if (($uZ(f(head)) !== false)) {
                    var this$5 = next;
                    next = this$5.tail__sci_List()
                  } else {
                    while ((nextToCopy !== next)) {
                      var newElem$2 = new $c_sci_$colon$colon().init___O__sci_List(nextToCopy.head__O(), $m_sci_Nil$());
                      currentLast.tl$5 = newElem$2;
                      currentLast = newElem$2;
                      var this$6 = nextToCopy;
                      nextToCopy = this$6.tail__sci_List()
                    };
                    var this$7 = next;
                    nextToCopy = this$7.tail__sci_List();
                    var this$8 = next;
                    next = this$8.tail__sci_List()
                  }
                };
                if ((!nextToCopy.isEmpty__Z())) {
                  currentLast.tl$5 = nextToCopy
      ...
      var validMoves = b.toList__sci_List()
    };
    var f$2 = (function(this$2$1, path$2, dict$1, solution$1) {
      return (function(move$3$2) {
        var move$3 = $as_LBoggle_Coord(move$3$2);
        var newPath = $as_sci_Vector(path$2.$$colon$plus__O__scg_CanBuildFrom__O(this$2$1.makeMove__sci_Vector__LBoggle_Coord__LBoggle_Coord(path$2, move$3), ($m_sci_Vector$(), $m_sc_IndexedSeq$().ReusableCBF$6)));
        var thiz = this$2$1.chain__sci_Vector__T(newPath);
        var head$1 = $as_T(thiz.toUpperCase());
        var f$1 = (function($this$1, head$2) {
          return (function(word$2) {
            var word = $as_T(word$2);
            return (($uI(word.length) >= 0) && ($as_T(word.substring(0, $uI(head$2.length))) === head$2))
          })
        })(this$2$1, head$1);
        if ((dict$1 instanceof $c_sci_List)) {
          var x2 = $as_sci_List(dict$1);
          var l$2 = x2;
          var l$3 = l$2;
          x$2: {
            var result$1;
            _noneIn$1: while (true) {
              if (l$3.isEmpty__Z()) {
                ...
                var h$1 = l$3.head__O();
                var this$18 = l$3;
                var t$1 = this$18.tail__sci_List();
                if (($uZ(f$1(h$1)) === false)) {
                  l$3 = t$1;
                  continue _noneIn$1
                };
                ...
                _allIn$1: while (true) {
                  if (remaining$3.isEmpty__Z()) {
                    ...
                    if (($uZ(f$1(x$2$1)) !== false)) {
                      var this$19 = remaining$3;
                      remaining$3 = this$19.tail__sci_List();
                      continue _allIn$1
                    };
                    var firstMiss$1 = remaining$3;
                    var newHead$1 = new $c_sci_$colon$colon().init___O__sci_List(start$1.head__O(), $m_sci_Nil$());
                    var toProcess$1 = start$1.tail__sci_List();
                    ...
                    while ((toProcess$1 !== firstMiss$1)) {
                      ...
                      var this$20 = toProcess$1;
                      toProcess$1 = this$20.tail__sci_List()
                    };
                    var next$1 = firstMiss$1.tail__sci_List();
                    var nextToCopy$1 = next$1;
                    while ((!next$1.isEmpty__Z())) {
                      var head$3 = next$1.head__O();
                      if (($uZ(f$1(head$3)) !== false)) {
                        var this$21 = next$1;
                        next$1 = this$21.tail__sci_List()
                      } else {
                        while ((nextToCopy$1 !== next$1)) {
                          ...
                          var this$22 = nextToCopy$1;
                          nextToCopy$1 = this$22.tail__sci_List()
                        };
                        var this$23 = next$1;
                        nextToCopy$1 = this$23.tail__sci_List();
                        var this$24 = next$1;
                        next$1 = this$24.tail__sci_List()
                      }
                    };
          ...
          $m_sci_Vector$();
          var b$1 = new $c_sci_VectorBuilder().init___();
          var this$26 = dict$1.iterator__sci_VectorIterator();
          while (this$26.$$undhasNext$2) {
            var arg1$1 = this$26.next__O();
            if (($uZ(f$1(arg1$1)) !== false)) {
              b$1.$$plus$eq__O__sci_VectorBuilder(arg1$1)
            }
          };
          var jsx$1 = b$1.result__sci_Vector()
        };
        var newDict = $as_sci_Vector(jsx$1);
        var newSolution = ($f_sc_SeqLike__contains__O__Z(newDict, head$1) ? $as_sci_Vector(solution$1.$$colon$plus__O__scg_CanBuildFrom__O(head$1, ($m_sci_Vector$(), $m_sc_IndexedSeq$().ReusableCBF$6))) : solution$1);
        return this$2$1.$$undsolve__p1__sci_Vector__sci_Vector__sci_Vector__sci_Vector(newDict, newPath, newSolution)
      })
    })(this, path, dict, solution);
    var this$28 = $m_sci_List$();
    var bf = this$28.ReusableCBFInstance$2;
    if ((bf === $m_sci_List$().ReusableCBFInstance$2)) {
      if ((validMoves === $m_sci_Nil$())) {
        var jsx$2 = $m_sci_Nil$()
      } else {
        var arg1$2 = validMoves.head__O();
        var h$2 = new $c_sci_$colon$colon().init___O__sci_List(f$2(arg1$2), $m_sci_Nil$());
        var t$2 = h$2;
        var rest = validMoves.tail__sci_List();
        while ((rest !== $m_sci_Nil$())) {
          var arg1$3 = rest.head__O();
          var nx = new $c_sci_$colon$colon().init___O__sci_List(f$2(arg1$3), $m_sci_Nil$());
          t$2.tl$5 = nx;
          t$2 = nx;
          var this$29 = rest;
          rest = this$29.tail__sci_List()
        };
        var jsx$2 = h$2
      }
    } else {
      var b$2 = $f_sc_TraversableLike__builder$1__psc_TraversableLike__scg_CanBuildFrom__scm_Builder(validMoves, bf);
      var these$1 = validMoves;
      while ((!these$1.isEmpty__Z())) {
        var arg1$4 = these$1.head__O();
        b$2.$$plus$eq__O__scm_Builder(f$2(arg1$4));
        var this$30 = these$1;
        these$1 = this$30.tail__sci_List()
      };
      var jsx$2 = b$2.result__O()
    };
    var sols = $as_sci_List(jsx$2);
    $m_sci_List$();
    var b$3 = new $c_scm_ListBuffer().init___();
    var these$2 = sols;
    while ((!these$2.isEmpty__Z())) {
      var arg1$5 = these$2.head__O();
      var xs = $as_sc_GenTraversableOnce(arg1$5).seq__sc_TraversableOnce();
      b$3.$$plus$plus$eq__sc_TraversableOnce__scm_ListBuffer(xs);
      var this$32 = these$2;
      these$2 = this$32.tail__sci_List()
    };
    var this$33 = b$3.toList__sci_List();
    return $as_sc_TraversableOnce($f_sc_SeqLike__distinct__O(this$33)).toVector__sci_Vector()
  }
});
$c_LBoggle_Board.prototype.visited__sci_Vector__LBoggle_Coord__Z = (function(path, pos) {
  return $f_sc_SeqLike__contains__O__Z(path, pos)
});
$c_LBoggle_Board.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
$c_LBoggle_Board.prototype.makeMove__sci_Vector__LBoggle_Coord__LBoggle_Coord = (function(path, move) {
  return $as_LBoggle_Coord(path.last__O()).$$plus__LBoggle_Coord__LBoggle_Coord(move)
});
...
$c_LBoggle_Die.prototype.init___sci_Vector = (function(faces) {
  this.faces$1 = faces;
  this.numFaces$1 = faces.length__I();
  return this
});
...
$c_LBoggle_Die.prototype.roll__T = (function() {
  ...
  return $as_T(this.faces$1.apply__I__O(idx))
});
...
$c_LBoggle_Matrix.prototype.toString__T = (function() {
  ...
  while (this$3.$$undhasNext$2) {
    ...
    var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this) {
      return (function(x$2) {
        var this$6 = new $c_sci_StringOps().init___T("%2s");
        var array = [x$2];
        var args = new $c_sjs_js_WrappedArray().init___sjs_js_Array(array);
        return $f_sci_StringLike__format__sc_Seq__T(this$6, args)
      })
    })(this));
    $m_sci_Vector$();
    var bf$1 = $m_sc_IndexedSeq$().ReusableCBF$6;
    b.$$plus$eq__O__scm_Builder($as_sc_TraversableOnce($f_sc_TraversableLike__map__F1__scg_CanBuildFrom__O(row, f, bf$1)).mkString__T__T(" "))
  };
  return $as_sc_TraversableOnce(b.result__O()).mkString__T__T("\n")
});
$c_LBoggle_Matrix.prototype.init___sci_Vector__s_reflect_ClassTag = (function(vec, evidence$1) {
  this.vec$1 = vec;
  this.evidence$1$1 = evidence$1;
  this.nrow$1 = vec.length__I();
  this.ncol$1 = $as_sc_SeqLike(vec.apply__I__O(0)).size__I();
  this.nelem$1 = $imul(this.nrow$1, this.ncol$1);
  var this$1 = vec.iterator__sci_VectorIterator();
  while (this$1.$$undhasNext$2) {
    var arg1 = this$1.next__O();
    var row = $as_sci_Vector(arg1);
    $m_s_Predef$().require__Z__V((row.length__I() === this.ncol$1))
  };
  return this
});
$c_LBoggle_Matrix.prototype.apply__I__I__O = (function(x, y) {
  return $as_sci_Vector(this.vec$1.apply__I__O(x)).apply__I__O(y)
});
$c_LBoggle_Matrix.prototype.shuffled__LBoggle_Matrix = (function() {
  var jsx$1 = $m_s_util_Random$();
  var this$1 = this.vec$1;
  $m_sci_Vector$();
  var b = new $c_sci_VectorBuilder().init___();
  var this$3 = this$1.iterator__sci_VectorIterator();
  while (this$3.$$undhasNext$2) {
    var arg1 = this$3.next__O();
  ...
  var shuffledVec = $as_sci_Vector(jsx$1.shuffle__sc_TraversableOnce__scg_CanBuildFrom__sc_TraversableOnce(b.result__sci_Vector(), ($m_sci_Vector$(), $m_sc_IndexedSeq$().ReusableCBF$6)));
  return new $c_LBoggle_Matrix().init___sci_Vector__I__I__s_reflect_ClassTag(shuffledVec, this.nrow$1, this.ncol$1, this.evidence$1$1)
});
$c_LBoggle_Matrix.prototype.init___sci_Vector__I__I__s_reflect_ClassTag = (function(v, nrow, ncol, evidence$2) {
  $m_s_package$();
  var b = new $c_sci_VectorBuilder().init___();
  var i = 0;
  while ((i < nrow)) {
    ...
    while ((i$1 < ncol)) {
      var arg1$1 = i$1;
      var elem = v.apply__I__O((($imul(arg1, ncol) + arg1$1) | 0));
      b$1.$$plus$eq__O__sci_VectorBuilder(elem);
      i$1 = ((1 + i$1) | 0)
    };
    var elem$1 = b$1.result__sci_Vector();
  ...
  $c_LBoggle_Matrix.prototype.init___sci_Vector__s_reflect_ClassTag.call(this, b.result__sci_Vector(), evidence$2);
  return this
});
...
$c_scm_ArrayBuffer.prototype.$classData = $d_scm_ArrayBuffer;
$e.Boggle = ($e.Boggle || {});
$e.Boggle.Main = $m_LBoggle_Main$;
$m_LBoggle_Main$().main__V();
}).call(this);
